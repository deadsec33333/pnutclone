	...
	$.fn.navAccordion = function(options, callback){
		this.each(function(){
			...
			var settings = $.extend({
				...
				selectedClass: "current-menu-parent",  //Class that will be used to detect the currently selected channel - this will check the "parentElement" for this class (the parent <li> by default)
